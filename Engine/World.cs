...
namespace Engine
{
    public class World
    {
        ...
        public const int ITEM_ID_ADVENTURER_PASS = 3;

        public const int MONSTER_ID_RAT = 1;
        public const int MONSTER_ID_SNAKE = 2;
        public const int MONSTER_ID_GIANT_SPIDER = 3;

        public const int QUEST_ID_CLEAR_ALCHEMIEST_GARDEN = 1;
        public const int QUEST_ID_CLEAR_FARMERS_FIELD = 2;

        public const int LOCATION_ID_HOME = 1;
        public const int LOCATION_ID_TOWN_SQUARE = 2;
        public const int LOCATION_ID_GUARD_POST = 3;
        public const int LOCATION_ID_ALCHEMIEST_HUT = 4;
        public const int LOCATION_ID_ALCHEMIEST_GARDEN = 5;
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion",
                "Healing potions", 5));
            Items.Add(new Item(ITEM_ID_SPIDER_FANG, "Spider fang", "Spider fangs"));
            Items.Add(new Item(ITEM_ID_SPIDER_SILK, "Spider silk", "Spider silks"));
            Items.Add(new Item(ITEM_ID_ADVENTURER_PASS, "Adventurer pass",     
                "Advenuter passes"));
        }
        ...
        private static void PopulateLocations()
        {
            ...
            alchemiestHut.LocationToSouth = townSquare;
            alchemiestHut.LocationToNorth = alchemiestGarden;

            alchemiestGarden.LocationToSouth = alchemiestHut;
            ...
            Locations.Add(alchemiestHut);
            Locations.Add(alchemiestGarden);
